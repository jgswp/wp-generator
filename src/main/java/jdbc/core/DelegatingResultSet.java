...
public final class DelegatingResultSet implements ResultSet {
    private final static int     WARN_ROWNUM = 20000;
    private final static Logger dbLogger;                                //日志Logger
    /**
     * 已读取行数
     */
    private long                 rowNum;
    ...
    static {
        dbLogger = Logger.getLogger("YDDB");
    }
    
    public static ResultSet wrapResultSet(ResultSet rset) {
        if (null == rset) {
            return null;
        }
        return new DelegatingResultSet(rset);
    }
     ...
     */
    private DelegatingResultSet(ResultSet res) {
        this._res = res;
        this.rowNum = 0;
    }
        ...
        try {
            ...
            if (ret) {
                ...
                if (rowNum >= WARN_ROWNUM) {
                    ...
                    dbLogger.warn("extractTime " + extractTime + " ms");
                }
            }
